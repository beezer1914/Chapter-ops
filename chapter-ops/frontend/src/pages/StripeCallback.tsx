...
export default function StripeCallback() {
  ...
  return (
    <div className="min-h-screen bg-white/5 flex items-center justify-center">
      <div className="bg-surface-card-solid rounded-xl shadow-lg p-8 max-w-md w-full text-center">
        {status === "loading" && (
          <>
            ...
            <p className="text-sm text-content-muted mt-2">Please wait a moment.</p>
          </>
        )}
