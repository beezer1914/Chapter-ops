...
class TestOrganizationStripeFields:
    ...
    def test_to_dict_includes_onboarding_flag(self, app, db_session):
        org = make_organization()
        ...
        # stripe_account_id is intentionally omitted (matches Chapter — avoids leaking acct id)
        assert "stripe_account_id" not in d
